...
protected:
	...
	int m_nViewRadius;				// The distance the player must be within to cause the enemy to go into CHASE state
...
public:
	...
	inline int GetViewRadius() const				{return m_nViewRadius;}
	...
	void SetViewRadius(int nViewRadius)				{m_nViewRadius = nViewRadius;}
