...
{
	CAnimationInstance m_PingAnimationInstance;
...
public:
	...
	void SetIsHackingTerminal(bool bIsHackingTerminal)	{m_bIsHackingTerminal = bIsHackingTerminal;}
