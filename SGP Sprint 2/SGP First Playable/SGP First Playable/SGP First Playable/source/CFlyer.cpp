...
CFlyer::CFlyer()
{
	...
	m_beeAnimationInstance = CAnimationManager::GetInstance()->SetAnimationInstance("../Resource/AnimationManagerStuff/sonicadvance2_enemies.bmp", "Flying");
	m_beeAnimationInstance.m_CurrSheet->m_nImageID = CSGD_TextureManager::GetInstance()->LoadTexture("Resource/AnimationManagerStuff/sonicadvance2_enemies.bmp", D3DCOLOR_XRGB(88,200,80));
	m_beeAnimationInstance.m_CurrAnimation->m_bIsLooping = true;
}
...
void CFlyer::Update(float fElapsedTime)
{
	...
	m_beeAnimationInstance.m_fCurrTime += fElapsedTime;
	m_beeAnimationInstance = CAnimationManager::GetInstance()->Animate(m_beeAnimationInstance);
}
...
void CFlyer::Render(void)
{
	...
	CSGD_TextureManager::GetInstance()->Draw(m_beeAnimationInstance.m_CurrSheet->m_nImageID, GetPosX() - OFFSET_X,
		GetPosY() - CTileManager::GetInstance()->GetCamera()->GetCameraPosY(), 1, 1, &m_beeAnimationInstance.m_CurrFrame->m_RImageRect);
