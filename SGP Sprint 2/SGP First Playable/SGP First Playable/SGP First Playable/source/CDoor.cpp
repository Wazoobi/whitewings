...
CDoor::CDoor(void)
{
	...
	CSGD_EventSystem::GetInstance()->RegisterClient("MINIGAMESUCCESS", this);
}

CDoor::~CDoor(void)
{
	CSGD_EventSystem::GetInstance()->UnregisterClient("MINIGAMESUCCESS", this);
}
...
void CDoor::Render(void)
{
	...
	if(m_bIsLocked)
		CSGD_TextureManager::GetInstance()->Draw(m_nImageID, GetPosX() - CTileManager::GetInstance()->GetCamera()->GetCameraPosX(), GetPosY() - CTileManager::GetInstance()->GetCamera()->GetCameraPosY(),1.0f, 1.0f, NULL, 0.0f, 0.0f, 0.0f, D3DCOLOR_ARGB(255, 255, 0, 0));
	else
		CSGD_TextureManager::GetInstance()->Draw(m_nImageID, GetPosX() - CTileManager::GetInstance()->GetCamera()->GetCameraPosX(), GetPosY() - CTileManager::GetInstance()->GetCamera()->GetCameraPosY(),1.0f, 1.0f, NULL, 0.0f, 0.0f, 0.0f, D3DCOLOR_ARGB(255, 0, 255, 0));
}
