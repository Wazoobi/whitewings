...
namespace WindowsFormsApplication1
{
    ...
    public partial class Form1 : Form
    {
        ...
        Layer[] TileLayers;
        short CurLayer = 1;
        int CURRENT_WIDTH = 15000;
        int CURRENT_HEIGHT = 2000;
        ...
        private void Image_Timer_Tick(object sender, EventArgs e)
        {
            ...
            hScrollBar1.Maximum = CURRENT_WIDTH;
            vScrollBar1.Maximum = CURRENT_HEIGHT;
            ...
            for (int i = (hScrollBar1.Value / TILE_WIDTH); i < (hScrollBar1.Value / TILE_WIDTH) + ImageViewPort.Width; ++i)
            {
                D3D_Image.DrawLine((i * TILE_WIDTH) - hScrollBar1.Value, ((vScrollBar1.Value / TILE_HEIGHT) * TILE_HEIGHT), (i * TILE_WIDTH) - hScrollBar1.Value, ImageViewPort.Height - vScrollBar1.Value, 1, 1, 1);
            }
            for (int i = (vScrollBar1.Value / TILE_HEIGHT); i < (vScrollBar1.Value / TILE_HEIGHT) + ImageViewPort.Height; ++i)
            {
                D3D_Image.DrawLine(((hScrollBar1.Value / TILE_WIDTH) * TILE_WIDTH), (i * TILE_HEIGHT) - vScrollBar1.Value, ImageViewPort.Width - hScrollBar1.Value, (i * TILE_HEIGHT) - vScrollBar1.Value, 1, 1, 1);
            }
            // End Line Drawing
            //////////////////////////////////////////////////////////////////////////
        ...
        {
            CURRENT_WIDTH = (int)numericUpDown3.Value;
        }

        private void numericUpDown4_ValueChanged(object sender, EventArgs e)
        {
            CURRENT_HEIGHT = (int)numericUpDown4.Value;
        }
